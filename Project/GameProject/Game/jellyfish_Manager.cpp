...
void jellyfish_Manager::Update() {
	...
	m_cut--;
	if (m_cnt <= 0) {
		new seaweed(CVector3D(Utility::Rand(m_scroll.x-100, m_scroll.x-100), (Utility::Rand(300, 500)), (Utility::Rand(-300,300))));
		m_cnt = Utility::Rand(120, 240);
	}
	if (m_cut <= 0)
	{
		new seaweed(CVector3D(Utility::Rand(m_scroll.x+1920+400, m_scroll.x+1920+400), (Utility::Rand(300, 500)), (Utility::Rand(-300, 300))));
